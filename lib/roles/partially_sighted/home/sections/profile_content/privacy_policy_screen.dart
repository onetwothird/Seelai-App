                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildPolicySection(
                          ...
                          content:
                              'SEELAI relies on your device\'s camera for object and face detection. To ensure your maximum privacy, all visual processing is performed locally on your device using TensorFlow Lite. We do not record, store, or transmit your live camera feed to external servers.',
                          textColor: textColor,
                        ...
                        _buildPolicySection(
                          ...
                          content:
                              'When registering a caretaker\'s face into the system, the facial mapping data is securely encrypted. This data is used strictly for the purpose of recognizing trusted individuals within your immediate vicinity.',
                          textColor: textColor,
                          subTextColor: subTextColor,
                        ),
                        ...
                        _buildPolicySection(
                          ...
                          content:
                              'Your location data is only accessed when the SOS emergency feature is activated. Upon activation, your precise location is transmitted exclusively to your registered caretakers to facilitate immediate assistance.',
                          textColor: textColor,
                          subTextColor: subTextColor,
                        ),
                        ...
                        _buildPolicySection(
                          ...
                          content:
                              'Personal and medical information (such as diagnosis and contact details) is stored securely in our Firebase backend. This information is only accessible to you and the caretakers you explicitly authorize via the web-based management dashboard. We do not sell your data to third parties.',
                          textColor: textColor,
                          subTextColor: subTextColor,
                        ),
