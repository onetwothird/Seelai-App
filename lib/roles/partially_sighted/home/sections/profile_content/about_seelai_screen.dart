                ...
                : Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                                ...
                                : [
                                    BoxShadow(
                                      color: _primaryColor.withValues(
                                        alpha: 0.25,
                                      ), // Soft purple glow instead of harsh black shadow
                                      blurRadius: 24,
                                      spreadRadius: -4,
                          ...
                          child: ClipRRect(
                            ...
                            child: Image.asset(
                              ...
                              fit: BoxFit
                                  .cover, // Removes the awkward white box-in-box look
                        ...
                        const SizedBox(
                          height: 24,
                        ), // Significantly reduced gap before cards
                        // ==================== CONTENT CARDS ====================
                        _buildSectionCard(
                          title: 'Our Mission',
                          icon: Icons.lightbulb_outline_rounded,
                          content:
                              'SEELAI is an intelligent mobile assistant dedicated to enhancing the daily activities and independence of partially sighted individuals. By bridging the gap between advanced technology and accessibility, we aim to provide a safer, more navigable world for our users.',
                          cardColor: cardColor,
                          textColor: textColor,
                        ...
                        _buildSectionCard(
                          ...
                          content:
                              'Powered by state-of-the-art machine learning, SEELAI utilizes the YOLO algorithm and TensorFlow Lite to provide rapid, on-device object and face detection. This ensures real-time environmental awareness without the constant need for an internet connection.',
                          cardColor: cardColor,
                          textColor: textColor,
                          subTextColor: subTextColor,
                        ),
                        ...
                        _buildSectionCard(
                          ...
                          content:
                              'SEELAI is built for collaboration. The system seamlessly connects users with their registered caretakers, allowing for trusted facial recognition, secure emergency SOS alerts, and remote technical model management.',
                          cardColor: cardColor,
                          textColor: textColor,
                          subTextColor: subTextColor,
                        ),
