...
class _HeaderSectionState extends State<HeaderSection>
  ...
  List<String> _getMascotMessages() {
    ...
    if (widget.currentStreak > 2) {
      messages.add(
        'Awesome! You are on a ${widget.currentStreak}-day streak! 🔥 Keep exploring your world!',
      );
    }

    if (widget.unreadNotificationCount == 0) {
      messages.add(
        'Hello, ${_getFirstName()}! You\'re all caught up. Tap the scanner whenever you\'re ready.',
      );
      messages.add(
        'Did you know? You can double tap the moon icon in the top right to toggle dark mode.',
      );
    } else {
      messages.add(
        'Hello, ${_getFirstName()}! You have ${widget.unreadNotificationCount} unread notification${widget.unreadNotificationCount > 1 ? 's' : ''}.',
      );
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(
                              18,
                            ), // Slightly rounder to match size
                          ),
                          child: Row(
