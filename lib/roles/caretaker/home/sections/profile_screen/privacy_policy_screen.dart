      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(width: 220, height: 32, color: Colors.white),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildPolicySection(
                          ...
                          content:
                              'As a caretaker, you are granted access to sensitive patient data, including real-time location and emergency SOS alerts. This access is strictly bound to the patients who have explicitly authorized your connection.',
                          textColor: textColor,
                        ...
                        _buildPolicySection(
                          ...
                          content:
                              'You do not have continuous access to the patient\'s live camera feed. Visual data and location are only transmitted during active SOS emergencies or specific assistance requests to protect patient autonomy.',
                          textColor: textColor,
                          subTextColor: subTextColor,
                        ),
                        ...
                        _buildPolicySection(
                          ...
                          content:
                              'Your contact information and facial mapping data (if registered into the system for recognition) are encrypted. This data is shared exclusively with your assigned patients to establish trust and recognition.',
                          textColor: textColor,
                          subTextColor: subTextColor,
                        ),
                        ...
                        _buildPolicySection(
                          ...
                          content:
                              'All data is stored securely using our Firebase backend services. We require all caretakers to act responsibly, maintain the confidentiality of the patients they monitor, and never share patient data with unauthorized third parties.',
                          textColor: textColor,
                          subTextColor: subTextColor,
                        ),
