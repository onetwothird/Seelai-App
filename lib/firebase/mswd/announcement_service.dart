...
class AnnouncementService {
  ...
  Future<String?> createAnnouncement(AnnouncementModel announcement) async {
    try {
      ...
      final announcementWithId = announcement.copyWith(
  ...
  Stream<List<AnnouncementModel>> getAnnouncementsStream() {
    return _announcementsRef.orderByChild('timestamp').onValue.map((event) {
  ...
  Future<List<AnnouncementModel>> getAnnouncements() async {
    try {
      final snapshot = await _announcementsRef.orderByChild('timestamp').get();
